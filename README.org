...
*** Usage
    ...
    Note: the cleanup scripts are written for windows, but this user ran them successfully using cygwin [https://github.com/olejorgenb/ColorNote-backup-decryptor/issues/9].
